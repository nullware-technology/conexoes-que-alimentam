...
export const mockChats: Chat[] = [
  {
    ...
    type: 'ONG',
    avatar: 'https://via.placeholder.com/100x100.png?text=Logo+1',
  ...
  },
  {
    ...
    type: 'Campanha',
    avatar: 'https://via.placeholder.com/100x100.png?text=Logo+2',
  ...
  },
  {
    ...
    avatar: 'https://via.placeholder.com/100x100.png?text=Logo+3',
  ...
  },
  {
    ...
    avatar: 'https://via.placeholder.com/100x100.png?text=Logo+4',
  ...
  },
  {
    ...
    type: 'Projeto Animal',
    avatar: 'https://via.placeholder.com/100x100.png?text=Logo+5',
